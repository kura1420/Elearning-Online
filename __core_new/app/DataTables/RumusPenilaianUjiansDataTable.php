...
class RumusPenilaianUjiansDataTable extends DataTable
{   

    protected $url = '/sch/rumus-penilaian-ujian';
     ...
     *
     * @param \App\RumusPenilaianUjian $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(RumusPenilaianUjian $model)
    {
    ...
    {
        return 'RumusPenilaianUjians_' . date('YmdHis');
    }
