...
class CreateRemedialUjianHarianHasilsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('remedial_ujian_harian_hasils', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->dateTime('tanggal');
            $table->boolean('status')->nullable();
            $table->integer('nilai', false, false)->nullable();
            $table->integer('total_pertanyaan', false, false);
            $table->integer('total_benar', false, false)->nullable();
            $table->integer('total_salah', false, false)->nullable();
    ...
    {
        Schema::dropIfExists('remedial_ujian_harian_hasils');
    }
}
