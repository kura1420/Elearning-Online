...
@section('titlePage') Import Pertanyaan @endsection

@section('addTitle') | Import Pertanyaan @endsection
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card stacked-form">
                        ...
                        <div class="card-body">
                            <form action="{{ url($url . '/' . $row->id . '/import-pertanyaan') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="file">{{ __('Import Pertanyaan') }} <span class="text-danger">*</span></label>
                                    <input type="file" name="file" id="file" class="form-control @error('file') is-invalid @enderror" value="{{ old('file') }}" placeholder="Import Pertanyaan">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ asset('template/soal_pertanyaan.xlsx') }}" class="btn btn-sm btn-success">
