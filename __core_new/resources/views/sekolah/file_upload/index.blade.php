...
<script src="{{ asset('assets/js/plugins/clipboard.js/dist/clipboard.min.js') }}"></script>
...
$(function () {
    ...
    const clipboard = new ClipboardJS('.btnCopyUrl');

    clipboard.on('success', function(e) {
        swal('URL sudah di copy, silahkan paste.');
    });

    clipboard.on('error', function(e) {
        swal('error copy data');
    });
    ...
    $('body').on('click', '.btnRemove', function () {
        ...
        swal({
            ...
            $.ajax({
                type: "DELETE",
                url: base_url + "sch/file-upload/" + val,
                dataType: "json",
