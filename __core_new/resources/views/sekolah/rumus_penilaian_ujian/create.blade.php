                        ...
                        <div class="card-body">
                            <form action="{{ url($url) }}" method="post" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="benar" id="benar" class="form-control @error('benar') is-invalid @enderror" value="{{ old('benar') }}" placeholder="Benar">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salah" id="salah" class="form-control @error('salah') is-invalid @enderror" value="{{ old('salah') }}" placeholder="Salah">
