                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Nama Guru"> 
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker @error('tanggal_masuk') is-invalid @enderror" id="tanggal_masuk" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" placeholder="Tanggal Masuk"> 
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="pelajaran[]" id="pelajaran" class="form-control selectpicker @error('pelajaran') is-invalid @enderror" multiple data-title="Pilih Pelajaran" data-style="btn-warning btn-fill btn-block" data-menu-style="dropdown-blue">
                                            ...
                                            <option value="{{ $pelajaran->id }}" {{ old('pelajaran') == $pelajaran->id ? 'selected' : '' }}> {{ $pelajaran->nama }} </option>
                                            @endforeach
                                        </select>
