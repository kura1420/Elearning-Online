...
<script src="{{ asset('assets/js/sekolah/soal_pertanyaan/edit_pg.js') }}"></script>
@endsection
                    ...
                    <div class="card stacked-form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <select name="kunci_jawaban" id="kunci_jawaban" class="form-control">
                                        ...
                                        <option value="e" style="{{ $soal->tipe_pilihan_ganda !== 'a-e' ? 'display:none;' : '' }}" {{ $benar == 'e' ? 'selected' : '' }}>E</option>
                                    </select>
                                </div>
                            </div>                         
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="jawaban_a" id="jawaban_a" cols="30" rows="10" class="jawaban">{{ isset($soalPertanyaanJawaban[0]->jawaban) ? $soalPertanyaanJawaban[0]->jawaban : NULL }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="jawaban_b" id="jawaban_b" cols="30" rows="10" class="jawaban">{{ isset($soalPertanyaanJawaban[1]->jawaban) ? $soalPertanyaanJawaban[1]->jawaban : NULL }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="jawaban_c" id="jawaban_c" cols="30" rows="10" class="jawaban">{{ isset($soalPertanyaanJawaban[2]->jawaban) ? $soalPertanyaanJawaban[2]->jawaban : NULL }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="jawaban_d" id="jawaban_d" cols="30" rows="10" class="jawaban">{{ isset($soalPertanyaanJawaban[3]->jawaban) ? $soalPertanyaanJawaban[3]->jawaban : NULL }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="{{ $soal->tipe_pilihan_ganda !== 'a-e' ? 'display:none;' : '' }}">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="jawaban_e" id="jawaban_e" cols="30" rows="10" class="jawaban">{{ isset($soalPertanyaanJawaban[4]->jawaban) ? $soalPertanyaanJawaban[4]->jawaban : NULL }}</textarea>
                                </div>
                            </div>
                        </div>
