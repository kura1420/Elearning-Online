                    ...
                    <div class="card-body table-full-width table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $soalPertanyaan->benar == 1 ? 'table-success' : 'table-danger' }}">
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        @php $jawabans = \App\SoalPertanyaanJawaban::where('soal_pertanyaan_id', $soalPertanyaan->id)->orderBy('urutan', 'asc')->get(); @endphp

                                        <table width="100%" style="width:100%;">
                                            <thead>
                                                <tr>
                                                    <th style="width:5%;">Dijawab</th>
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                $jawabanSiswa = strlen(array_search($jawaban->id, array_column($ujianHarianJawabanSiswa, 'soal_pertanyaan_jawaban_id')));
                                                @endphp

                                                <tr class="{{ ! empty($jawabanSiswa) ? 'table-warning' : '' }}">
                                                    <td> 
                                                        <i class="{{ ! empty($jawabanSiswa) ? 'fa fa-pencil' : '' }}"></i>
                                                    </td>
                                                    <td> 
                                                        @if($jawaban->benar) 
