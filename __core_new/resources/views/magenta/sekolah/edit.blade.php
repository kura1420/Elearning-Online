...
<script src="{{ asset('assets/js/magenta/sekolah/edit.js') }}"></script>
<script>
@php
if (isset($pic_sekolahs)) {
    ...
    $jsonEncode = json_encode($jsonPicSekolah);
}
@endphp

pic_sekolah = @php echo $jsonEncode; @endphp;
</script>
@endsection
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Sekolah" autofocus value="{{ $row->nama }}">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody id="tableListPic">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $ps->jabatan }}</td>
                                    <td>
                                        <button class="btn btn-sm btn-danger btnRemovePic" value="{{ $ps->id }}">
