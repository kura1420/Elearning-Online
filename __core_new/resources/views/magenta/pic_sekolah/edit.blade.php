                    ...
                    <div class="card stacked-form">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ $row->nama }}" placeholder="Nama Lengkap" autofocus> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="handphone" id="handphone" class="form-control @error('handphone') is-invalid @enderror" value="{{ $row->handphone }}" placeholder="Handphone"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telp" id="telp" class="form-control @error('telp') is-invalid @enderror" placeholder="Telp." value="{{ $row->telp }}"> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jabatan" id="jabatan" class="form-control @error('jabatan') is-invalid @enderror" placeholder="Jabatan" value="{{ $row->jabatan }}"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sekolah" id="sekolah" class="selectpicker" data-title="Pilih" data-style="btn-warning btn-outline" data-menu-style="dropdown-blue" data-live-search="true">
                                            ...
                                            <option value="{{ $sekolah->id }}" {{ $row->sekolah_id == $sekolah->id ? 'selected' : '' }}>{{ $sekolah->nama }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat">{{ $row->alamat }}</textarea>
                    ...
                    <div class="card stacked-form">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Username" value="{{ isset($user->username) ? $user->username_sch : '' }}" {{ isset($user->username) ? 'disabled' : '' }}>
