$(function () {
    ...
    var jadwal = Object.keys(obj).length > 0 ? obj : [];    
    ...
    const main = {
        ...
        _pageEvent: () => {
            ...
            $('body').on('click', '.btnDelete', function() {
                ...
                let filterDeleteJadwal = jadwal.filter(o => o.pelajaran_id === id && o.kelas_id === val);

                $.ajax({
                    type: "POST",
                    url: base_url + "app-svc/tahun-ajaran-jadwal/destroy",
                    data: {
                        pelajaran_id: id,
                        kelas_id: val,
                        user_guru_id: filterDeleteJadwal[0].user_guru_id,
                        tahun_ajaran_id: _id.val()
                    },
                    dataType: "json",
